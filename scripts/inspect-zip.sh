...
n=$(dls product.img /priv-app/GmsSupervision | grep -c '\.apk$'); [ "$n" -ge 1 ] && ok "GmsSupervision: $n plik(ów) .apk — stub 0.1.453788429, Play nadpisze pełną wersją" || bad "GmsSupervision: brak .apk"
